...
subject_id = str(input("Enter the subject ID: "))
...
if answear == "YES": # Do this. 
    ...
    ##### 
        ...
        print ("The protocol number is incorrect")
...
#subjects = [
   ...
   # {} # Visitis from Subject 2
    ...
    def write_csv():
        ...
        csvfile = open("subject_visits.csv","w")
       ...
       # writer.writerow()
        writer.writerow ({"Subject_ID": subject_id, "Screening day": screening_day, "Baseline visit:": baseline_visit, "First Follow-up visit": date_required_1, "Second Follow-up visit": date_required_2, "Third Follow-up visit": date_required_3, "Fourth Follow-up visit": date_required_4})
        csvfile.close()
